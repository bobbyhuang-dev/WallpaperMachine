...
def main():
    ...
    for binary in ["render_target_lifetime_test", "text_object_runtime_test", "shader_cache_metadata_test",
                   ...
                   "shared_video_session_test", "render_scale_test", "static_subgraph_cache_test", "scene_mesh_tests", "particle_rope_geometry_test", "particle_mouse_controlpoint_test", "layer_texture_reference_test",
                   "timer_tests", "playback_gpu_test", "metal_backend_test", "metal_scene_draw_smoke",
                   "metal_poster_capture_test", "metal_video_texture_test"]:
