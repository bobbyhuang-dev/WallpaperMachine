...
def main():
    ...
    for binary in ["render_target_lifetime_test", "text_object_runtime_test", "shader_cache_metadata_test",
                   ...
                   "shared_video_session_test", "render_scale_test", "static_subgraph_cache_test", "particle_rope_geometry_test",
