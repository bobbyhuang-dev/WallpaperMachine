...
def main():
    ...
    if not args.skip_build:
        ...
        steps = [
            ...
            (["cmake", "--build", build, "--target", "offscreen_scene_probe", "scene_reload_cycle_probe", "render_target_lifetime_test", "text_object_runtime_test", "shader_cache_metadata_test", "video_decode_pump_test", "video_color_conversion_test", "video_frame_pacing_test", "video_conversion_budget_test", "video_source_input_test", "shared_video_session_test", "render_scale_test", "timer_tests", "playback_gpu_test", "-j", "6"], "build", ROOT),
        ]
    ...
    for binary in ["render_target_lifetime_test", "text_object_runtime_test", "shader_cache_metadata_test",
                   ...
                   "shared_video_session_test", "render_scale_test",
    ...
    return int(any(report[k] for k in ["render_target_lifetime_test", "text_object_runtime_test", "shader_cache_metadata_test", "video_decode_pump_test", "video_color_conversion_test", "video_frame_pacing_test", "video_conversion_budget_test", "video_source_input_test", "shared_video_session_test", "render_scale_test", "timer_tests", "playback_gpu_test", "scene_reload_cycle_probe"]) or any(not c["pixels_equal"] for c in report["cases"]) or any(c["diagnostics"] or not c.get("expected_pixels", False) for c in report["cases"][:GENERATED_CASE_COUNT]))
